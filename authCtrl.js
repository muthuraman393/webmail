var navCtrl = app.controller('navCtrl', ['$scope', '$rootScope', '$routeParams', '$location', '$filter','$http','Entry' ,function($scope, $rootScope, $routeParams, $location, $filter,$http,Entry) {
    $scope.homeitems = [{
        nameid: 'ford_1',
